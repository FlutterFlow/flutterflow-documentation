...
An API token is required to use the [CLI](../ff-concepts/advanced/ff-cli.md) and the [Visual Studio Code Extension](../ff-concepts/adding-customization/vscode-extension.md)
.
