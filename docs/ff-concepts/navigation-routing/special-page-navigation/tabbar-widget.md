...
title: TabBar
description: >-
  Learn how to use the TabBar widget in FlutterFlow to create a horizontal row
  of tabs for navigating different content views in your app.
...
2. By default, it adds three tabs and shows the first one in the canvas. In the widget tree, each pair is represented as **Tab** and **TabBar Page**. To edit another tab, select the **TabBar** and set **Active Tab** in the Properties Panel.
...
5. To add a tab, open **Properties Panel > Active Tab** and select **+ Add Tab**.
...
- You can read the zero-based current and previous indexes from **Set from Variable > Widget State > [TabBar name] Current Index** and **Previous Index**.
:::
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/ff3d384fd8504de89dc872d419888865?sid=43ec3262-e6f8-449f-900e-484bbb289e94" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/574d765ca61a4268bc63b76e4a388239?sid=f3c12da4-cb37-4ef3-91f3-0cb6f55c76c9" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
5. When the style is set to **Toggle** **Button**, you have the following options to customize:
    ...
    4. You can also set the **Elevation**. **Button Margin** is available for the Button style, not Toggle Button.
...
<video className="docs-video" autoPlay loop muted playsInline controls aria-label={"Setting the initial TabBar index"}><source src={require("./imgs/setting-initial-tab-index.mp4").default} type="video/mp4" /></video>
...
To make a TabBar scrollable, select the TabBar widget and enable **Properties Panel > General Properties > Tab Bar Scrollable**.

:::info
When **Tab Bar Scrollable** is enabled, use **Tab Bar Horizontal Alignment** to align the scrollable tab strip to the left, center, or right where supported by the project's Material configuration.
:::
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/aa94fef50d034822a4aa997227cd8f9f?sid=466570b0-2240-4666-bec2-07020ef2b6a7" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
By default, users can switch tabs by swiping the content or selecting a tab. To disable the swipe gesture, enable **Properties Panel > General Properties > Prevent Swiping To Switch Tabs**.
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/86e5bfa6c7d846a9aa8ef7c16395a93a?sid=6a3d8a32-52df-44a3-b182-58ce7c3e0407" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/c0460343287b4d628c11160ff0e06d57?sid=03f002b3-4589-4214-8e35-ae31b41f5425" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/7a8454f15bec4df5a45b4e54c967b3cd?sid=36c3441f-66ba-42ff-a354-f7727f14ea81" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
4. Set **Tab Bar to Control** to a TabBar in the same page or component as the action. A Control Tab Bar action cannot target a TabBar in another scope.
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.loom.com/embed/4b3bbd2ea16e43928f91827ef019064a?sid=ee520d4c-3c5e-4308-bb0a-9e318f3be83f" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
...
<div style={{
    ...
    width: '100%'}}>
    <iframe
        src="https://www.youtube.com/embed/L3hyUQlUi9E" title="TabBar interactive tutorial"
        style={{
            position: 'absolute',
            top: 0,
            left: 0,
