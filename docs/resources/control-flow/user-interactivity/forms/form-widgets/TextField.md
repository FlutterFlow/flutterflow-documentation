...
![change-textfield-background-color](../../imgs/change-textfield-background-color.gif)
...
![add-content-padding](../../imgs/add-content-padding.gif)
...
![reducing-textifled-height](../../imgs/reducing-textifled-height.gif)
...
![clear-textfield](../../imgs/clear-textfield.gif)
...
![Hiding keyboard on tap-1](../../imgs/hide-keyboard-tap.gif)
