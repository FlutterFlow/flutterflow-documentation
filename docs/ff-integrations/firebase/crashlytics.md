...
2. To test the crash on your app, [download the app](../../ff-concepts/advanced/ff-cli.md#download-projects), add a code that throws an error, and run it on a mobile device or emulator with an active internet connection.
