...
- **Projects**: Projects section displays all the projects you have created in FlutterFlow. Use the overflow menu to rename, duplicate, delete, leave the project, add tags, and open the project in a new browser tab.
    ...
    :::info
    When you duplicate a project with Firebase configured, you must delete the config files in the duplicated project and initiate a new [**Firebase setup**](../../ff-integrations/firebase/connect-to-firebase-setup.md) for it.
    :::
...
- **Tag Projects**: You can create and add a tag to projects, providing a quick and organized way to classify and identify projects based on their characteristics, purpose, or status.

    To tag a project, open the three-dot overflow menu on the project tile, select **Add Tag**, and then select the tag you want to set. Later, you can search and filter projects based on their tags.
    ...
    width: '100%'}}>
    <iframe
        src="https://demo.arcade.software/RVgwXtGKdY9bb7WSZjpw?embed&show_copy_link=true"
        title=""
        style={{
            position: 'absolute',
            top: 0,
...
- **Marketplace**: Use the [**FlutterFlow Marketplace**](../../marketplace/index.md) to access prebuilt components and templates created by other users and add new functionality to your app.
...
- **URL Access (Only Available for Enterprise Users)**: You can view and copy URLs that need to be whitelisted for FlutterFlow to function correctly in enterprise environments with restricted internet access. See **[Whitelisting URLs](../../misc/enterprise-page.md#whitelist-urls)** for more information.
