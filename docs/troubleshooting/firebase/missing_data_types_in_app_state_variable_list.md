...
slug: troubleshooting/firebase/missing-data-types-in-app-state-variable-list
...
If the issue persists, please contact **FlutterFlow Support** for further assistance.
