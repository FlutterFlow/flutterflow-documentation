...
description: >-
  This article demonstrates common errors and issues that may occur when
  creating a in FlutterFlow, along with steps to resolve them.
tags:
  - FlutterFlow
  - Troubleshooting
  - Widget
...
![Custom Widget Errors in FlutterFlow](../assets/20250430121322843622.gif)
...
<video className="docs-video" autoPlay loop muted playsInline controls aria-label={"Correcting a FlutterFlow Custom Widget error"}><source src={require("../assets/20250430121323364253.mp4").default} type="video/mp4" /></video>
:::
...
**Common Errors and Solutions:**
    ...
    - **Widget Name Conflicts with Package Name**
        ...
        ![Custom Widget Errors in FlutterFlow](../assets/20250430121324152439.png)

        ![Custom Widget Errors in FlutterFlow](../assets/20250430121324382074.png)
    ...
    - **Missing Package Imports in Code**
        ...
        ![Custom Widget Errors in FlutterFlow](../assets/20250430121324695186.png)
        ...
        Here is how to fix this issue:
            ...
            - Copy and paste the correct import statement into your custom widget code.
                ...
                ![Custom Widget Errors in FlutterFlow](../assets/20250430121324981835.png)
    ...
    - **Widget Name Mismatch Between UI and Code**
        ...
        ![Custom Widget Errors in FlutterFlow](../assets/20250430121326300880.png)

        Corrected version with matching names:

        ![Custom Widget Errors in FlutterFlow](../assets/20250430121326628836.png)
...
See [Emoji Size on iOS Devices](/troubleshooting/widget/emoji-size-on-ios-devices) for a related FlutterFlow workflow.
